...
#define nan_multiplier 1000 //multiplier for nanosleep
...
void do_at_exit(); //clean up function
...
int main(int argc, char **argv){
	...
	// if((semafor_enter = sem_open("/xbubel08_IOS_proj2_semafor",  O_CREAT | O_EXCL, 0664, 1)) == SEM_FAILED){
...
//initialize semaphores and sared memory, open output file
int initialize(){
...
void do_at_exit(){
	...
	// munmap(acces,sizeof(shared_memory));
